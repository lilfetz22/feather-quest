...
public static class FocusCalculator
{
    ...
    /// <param name="centerTolerance">Distance from center considered "perfect" (default: 0.0, meaning exact center only)</param>
    ...
    public static float CalculatePhotoQuality(Vector2Simple finalReticlePos, float stabilityAvg, float centerTolerance = 0.0f)
    {
        ...
        // Maximum possible distance is sqrt(2) (corner of the frame at (±1, ±1))
